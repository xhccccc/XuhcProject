...
public class ThreadPoolManager {
    ...
    private static final String TAG = "xhccc" + ThreadPoolManager.class.getSimpleName();
    ...
    private ThreadPoolManager() {
        ...
        Log.d(TAG,"corePoolSize: " + corePoolSize);
        Log.d(TAG,"maximumPoolSize: " + maximumPoolSize);
    }
