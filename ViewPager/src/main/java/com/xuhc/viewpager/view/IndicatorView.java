package com.xuhc.viewpager.view;
...
public class IndicatorView extends LinearLayout {
    ...
    private void bindView(Context context) {
        LayoutInflater.from(context).inflate(R.layout.linearlayout_indicatorview, this, true);
        llIndicatorView = findViewById(R.id.ll_indicatorview);
